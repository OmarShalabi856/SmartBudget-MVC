...
namespace SmartBudget.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,Note,Date,CategoryId")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Note,Date,CategoryId")] Transaction transaction)
        {
